...
\begin{tikzpicture}[remember picture,overlay]
    ...
    \fill[magenta,opacity=0.4] (top) ++(15mm,-15mm) rectangle +(\paperwidth-15mm-10mm,-19.5mm);
    \fill[magenta,opacity=0.2] (top) ++(15mm,-15mm-19.5mm) rectangle +(\paperwidth-15mm-10mm,-19.5mm);
