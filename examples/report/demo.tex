\documentclass[oneside,useseriffont=false,fontsize=cdfont]{tudcdreprt}
...
\NewCommandCopy\getgridwidth\tudcd@getgridcolumnwidth%
\makeatother

\title{Numerische Untersuchungen verschiedener Algorithmen zur Lösung von Kristallplastizitätsmodellen bei kleinen Deformationen}
\subtitle{Ein Streifzug durch die Mikrophysik, Gruppentheorie, Festkörpermechanik, Konvexe Analysis, Optimierung und Implementierung}
...
{\tiny Ich bin \verb|\tiny| mit \getfontsize,\the\baselineskip{} \par}
