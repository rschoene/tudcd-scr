...
Zeilenanstand 21 pt}
\author[Vortragende]{Yoshi Diepelt, Paul Erdős}
%\struktureinheit{}
...
\begin{frame}
\only<1>{\textcdul{Ich bin ein Test Ultra Light}}%
\only<2>{\textcdel{Ich bin ein Test Extra Light}}%
\only<3>{\textcdl{Ich bin ein Test Light}}%
\only<4>{\textcdsl{Ich bin ein Test Semi Light}}%
\only<5>{\fontseries{medium}\selectfont Ich bin ein Test Medium voll\par}
\only<6>{\textcdm{Ich bin ein Test Medium}}%
\only<7>{\textcdsb{Ich bin ein Test Semi bold}}%
\only<8>{\textcdb{Ich bin ein Test Bold}}%
\only<9>{\textcdeb{Ich bin ein Test Extra Bold}}%
\only<10>{\textcdub{Ich bin ein Test Ultra Bold}}%
\end{frame}
