...
Die Titelfolie, welche mit \lstinline|\maketitle| gesetzt wird, hat mehrere \emph{Farbmodi},
welche die Farbe beeinflussen.
Diese können durch das Umschalten der Beamertemplate \lstinline|title page/colormode| eingestellt werden.
\begin{lstlisting}
