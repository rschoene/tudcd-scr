...
\begin{tikzpicture}[remember picture,overlay]
    ...
    \fill[magenta,opacity=0.4] (top) rectangle +(15mm,-15mm) node[pos=0.5,black] {A \num{15}x \qty{15}{\mm}};
    \fill[magenta,opacity=0.4] (top) ++(\paperwidth,0mm) rectangle +(-10mm,-15mm) node[pos=0.5,black] {B\qty{10}{\mm}};
    \fill[magenta,opacity=0.4] (top) ++(15mm,-15mm) rectangle +(\paperwidth-15mm-10mm,-19.5mm) node[pos=0.5,black,font=\Large] {Logobereich H\qty{19}{\mm}};
    \fill[magenta,opacity=0.2] (top) ++(15mm,-15mm-19.5mm) rectangle +(\paperwidth-15mm-10mm,-19.5mm) node[pos=0.5,black,font=\Large] {Schutzraum H\qty{19}{\mm}};

    \fill[magenta,opacity=0.4] (bottom) ++(15mm,23.767mm) rectangle +(\paperwidth-15mm-10mm,-23.767mm) node[pos=0.5,black,font=\Large] {Freihaltezone H\qty{23}{\mm}};
  \end{tikzpicture}
}
